...
// --- FIXED OPTIMISTIC UPDATE (Receives explicit frontend IDs now) ---
...
function saveInvoice() { 
    ...
    document.getElementById('inv_rec_amount').value = ''; showView('dashboardView'); 
}
